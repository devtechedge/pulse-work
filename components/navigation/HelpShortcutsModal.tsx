  ...
  return (
    ...
    >
      <div className="space-y-6 font-mono text-xs">
        <div className="p-3 rounded bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 flex items-center gap-3">
        ...
        <div>
          <h3 className="font-bold text-slate-200 mb-3 flex items-center gap-2">
            <Keyboard className="w-4 h-4 text-cyan-400" /> Keybindings
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {shortcuts.map((sc) => (
              <div
                key={sc.key}
                className="p-2.5 rounded bg-white/5 border border-white/10 flex items-center justify-between"
              >
                <span className="text-slate-300">{sc.desc}</span>
                <kbd className="px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 font-bold">
                  {sc.key}
                </kbd>
              </div>
            ))}
        ...
        <div>
          <h3 className="font-bold text-slate-200 mb-3 flex items-center gap-2">
            <TouchpadIcon className="w-4 h-4 text-emerald-400" /> Touch & Mobile Gestures
          </h3>
